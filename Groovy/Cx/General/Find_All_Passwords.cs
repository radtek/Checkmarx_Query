CxList allStrings = All.FindByType("String") + All.FindByType(typeof(StringLiteral)) + All.FindByType(typeof(UnknownReference))
...
CxList constNotPass = 
	allConstantPass.FindByShortName("password_*", false) + 
	allConstantPass.FindByShortName("psw_*", false) + 
	allConstantPass.FindByShortName("pwd_*", false) + 
	allConstantPass.FindByShortName("pass_*", false);
