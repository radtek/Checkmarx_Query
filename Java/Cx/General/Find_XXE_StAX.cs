...
CxList xml_parse_mthds = methods.FindByMemberAccess("XMLInputFactory.createXMLStreamReader");
xml_parse_mthds.Add(methods.FindByMemberAccess("XMLInputFactory.createXMLEventReader"));
