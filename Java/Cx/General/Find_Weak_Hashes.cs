...
CxList weakKeysStrings = All.NewCxList();
weakKeysStrings.Add(msgDigest);
...
CxList weakHashingPkg = methods.FindByMemberAccess("Hashing.MD5");
weakHashingPkg.Add(methods.FindByMemberAccess("Hashing.SHA1"));
CxList hasher = declarators.FindByType("Hasher").DataInfluencedBy(weakHashingPkg);
