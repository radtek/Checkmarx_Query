...
CxList hibernateParam_NotFirst = hibernate.FindByShortName("find*");
hibernateParam_NotFirst.Add(hibernate.FindByShortName("iterate"));
...
Criteria.Add(All.FindByTypes(new string[] {
	"*Criteria",
	"Subcriteria",
	"CriteriaImpl",
	"Projections",
