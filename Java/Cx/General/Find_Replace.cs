CxList replaceMethods = All.FindByShortName("replace*", false);

CxList replace = replaceMethods.FindByType(typeof(MemberAccess)); 
replace.Add(replaceMethods.FindByType(typeof(MethodInvokeExpr)));
