...
sanitizers.Add(Find_Inacurate_Hard_coded_Inputs());

result = sinks.InfluencedByAndNotSanitized(strLiterals, sanitizers).ReduceFlow(CxList.ReduceFlowType.ReduceBigFlow);