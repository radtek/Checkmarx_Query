...
CxList directPrepare = 
	methods.FindByMemberAccess("ConnectionWrapper.prepareStatement");
...
result = directPrepare.DataInfluencingOn(setPrms) + All.GetByAncs(prms) + setParameters;