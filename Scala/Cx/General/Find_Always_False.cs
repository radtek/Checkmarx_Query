...
CxList ternary_exps = All.FindByType(typeof(TernaryExpr));
...
CxList sanitizer = expr_in_ter + binaryExpr + unaryExpr + equal + parameters;
...
CxList setters = Find_MethodDeclaration().FindByShortName("set*");
