...
// 3) Add exceptions (that could be thrown) to outputs. This format is irrelevant to C++ 
// C++ exceptions could be any kind of object (string, integer, or any other class instance), and so the code block is unnecessary
