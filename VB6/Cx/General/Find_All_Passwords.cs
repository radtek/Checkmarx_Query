...
allStrings.Add(All.FindByType(typeof(UnknownReference)));
allStrings.Add(All.FindByType(typeof (Declarator)));
allStrings.Add(All.FindByType(typeof(MemberAccess)));
 
CxList tempResult = allStrings.FindByShortName("*password", false);
tempResult.Add(allStrings.FindByShortName("password*", false));
tempResult.Add(allStrings.FindByShortName("*psw", false));
tempResult.Add(allStrings.FindByShortName("psw*", false));
tempResult.Add(allStrings.FindByShortName("pwd*", false));
tempResult.Add(allStrings.FindByShortName("*pwd", false)); 
