...
CxList passwords = All.NewCxList();
...
CxList constPass = passwords.FindByType(typeof (ConstantDecl));
...
CxList constantsToRemove = allConstantPass.FindByShortName("password_*", false);
constantsToRemove.Add(allConstantPass.FindByShortName("psw_*", false));
constantsToRemove.Add(allConstantPass.FindByShortName("pwd_*", false));
constantsToRemove.Add(allConstantPass.FindByShortName("pass_*", false));

result = passwords - constantsToRemove;