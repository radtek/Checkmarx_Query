...
CxList exceptions = All.FindByType(typeof(ObjectCreateExpr)).FindByName("*Exception", false);
CxList exceptionsCtors = All.FindByType(typeof(ConstructorDecl)).FindByName("*Exception", false);
